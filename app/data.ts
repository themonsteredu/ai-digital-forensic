...
export const LESSON_STEPS = [
  ...
  },
  {
    ...
    student: "PIN 단서를 해석하고 공폰의 사건 관련 디지털 흔적을 자유롭게 찾습니다.",
    reaction: "교사에게 어느 앱을 열어야 하는지 바로 묻는 경우가 많습니다.",
    hint: "‘사진 외에도 시간이 남는 기록은 무엇일까?’까지만 안내합니다.",
    caution: "수업용 공폰 외 개인 휴대폰은 조사하지 않습니다.",
  },
  {
    title: "3. 디지털 증거 등록",
    teacher: "학생이 발견한 코드가 실제 공폰 화면의 자료에서 나온 것인지 확인합니다.",
    student: "DF-2048을 시스템에 등록하고 삭제 흔적과 저장 위치를 판독합니다.",
    reaction: "삭제 흔적을 발견하면 곧바로 사진 내용까지 안다고 생각할 수 있습니다.",
    hint: "‘흔적이 있다는 것’과 ‘내용을 복구한 것’은 다르다고 질문하세요.",
    caution: "증거번호를 다른 모둠에 큰 소리로 알려주지 않도록 합니다.",
  },
  {
    title: "4. microSD 삭제 데이터 복구",
    teacher: "microSD를 분리하고 리더기에 연결하도록 안내한 뒤 지정된 무료 복구 도구의 검색 범위만 확인합니다.",
    student: "읽기 중심으로 검색하고 복구 결과의 원본·썸네일·흔적·복구 불가 상태를 구분합니다.",
